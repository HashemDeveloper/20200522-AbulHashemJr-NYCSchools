...
public class SatScorePage extends Fragment {
    public FragmentSatScoreLayoutBindingImpl binding;
    @Inject
    public SatScorePageViewModel.Factory viewModelFactory;
    private NavController navController;
    private SatScorePageViewModel satScorePageViewModel;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        this.satScorePageViewModel = new ViewModelProvider(requireActivity(),
                new ViewModelFactory<SatScorePageViewModel>(this.viewModelFactory, requireActivity(), savedInstanceState))
                .get(SatScorePageViewModel.class);
        ...
        this.satScorePageViewModel.fetchSATScores(id);
        this.satScorePageViewModel.getViewStatusLiveData().observe(getViewLifecycleOwner(), new Observer() {
            @Override
